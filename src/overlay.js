...
(function () {
  ...
  style.textContent = [
    ...
    ".nav{font-size:var(--t-body);letter-spacing:0;padding:10px 9px}",
    ...
    ".sheet h4{margin:0;padding:13px 15px 10px;font:400 var(--t-lead)/var(--lh-tight) var(--display);",
    ...
    ".fam{padding:11px 15px 3px;color:var(--ink-3);font:var(--t-micro)/var(--lh-body) var(--mono);",
    "text-transform:uppercase;letter-spacing:var(--track-micro)}",
    ".foot{padding:11px 15px 13px;color:var(--ink-3);font:var(--t-micro)/var(--lh-open) var(--mono);",
